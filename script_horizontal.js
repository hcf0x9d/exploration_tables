...
class TableIt {
    ...
    buildTableHeaders() {
        ...
        this.data.headers.forEach( ( header, idx ) => {
            ...
            // This is so dumb
            if ( idx === 0 ) {
                cell.className += ' sticky left-0'
            } else if ( idx === ( this.data.headers.length - 1 ) ) {
                cell.className += ' sticky right-0 mod-sticky-before'
            }
    ...
    buildTableCell( set, item, idx ) {
        ...
        if ( idx === 0 ) {
            ...
            cell.className += ' sticky left-0 bg-white';
        ...
        if ( idx === Object.keys(set).length - 2 ) {
            ...
            cell.className += ' sticky mod-sticky-before right-0 bg-white'
